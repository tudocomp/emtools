...
namespace stream
{
    ...
    public:
        ...
        typedef typename element_iterator_traits<block_type>::element_iterator element_iterator;
    ...
    protected:
        ...
        {
            check_sort_settings();
            algorithm::Sort<element_iterator,cmp_type>
...
//            fprintf(stderr, "input_buffers = %ld, nruns + min_prefetch_buffers = %ld\n",
//                    (long)input_buffers, (long)(nruns + min_prefetch_buffers));
